...
const benefits = [
  ...
  {
    key: 'brand',
    title: 'Выгляди профессионально перед любой аудиторией',
    description:
      'Выбери готовый или загрузи корпоративный шаблон. GoDeck выстроит композицию и применит фирменное оформление ко всей презентации.',
  },
] as const
