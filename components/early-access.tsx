...
const plans = [
  {
    ...
    cta: 'Создать презентацию бесплатно',
    highlighted: false,
  },
  {
    ...
    items: ['Готовый PPTX и PDF', 'Можно применить шаблон к этой презентации', 'Без подписки'],
    cta: 'Создать презентацию бесплатно',
    highlighted: true,
  },
  {
    ...
    items: ['Выгодно от 3 презентаций в месяц', 'КП, отчёты и статусы в одном тарифе', 'Сохранённый фирменный стиль компании', 'Помесячная оплата'],
    cta: 'Создать презентацию бесплатно',
    highlighted: false,
  },
]
  ...
  return (
    <section id="capabilities" className="scroll-mt-16 bg-navy text-navy-foreground">
      <div className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-24">
        ...
        <p className="pt-8 text-center text-sm text-navy-foreground/70">
          Загрузите материалы и получите структуру и черновик презентации. Карта не требуется.
        </p>
      </div>
    </section>
  )
