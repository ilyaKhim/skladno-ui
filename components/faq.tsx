...
const items = [
  { q: 'Сколько стоит презентация?', a: 'Превью — бесплатно: вы сразу видите структуру и черновик слайдов. Готовая презентация под одну задачу — 290 ₽. Для регулярной работы — 1 090 ₽/месяц без лимита по числу задач.' },
  ...
  { q: 'Что делать, если нужна только одна презентация?', a: 'Начните с бесплатного превью: опишите задачу или загрузите материалы, проверьте структуру и оплатите готовую презентацию за 290 ₽.' },
