...
const items = [
  ...
  { q: 'Можно ли изменить только один слайд?', a: 'GoDeck оставляет презентацию редактируемой, поэтому отдельные слайды можно поправить в PowerPoint после выгрузки.' },
  ...
  { q: 'Чем GoDeck отличается от ChatGPT, Canva и шаблонов?', a: 'GoDeck соединяет задачу, структуру и деловые слайды в одном последовательном процессе, а на выходе даёт редактируемый PPTX.' },
]
