  ...
  return (
    <section id="top" className="border-b border-border">
      <div className="mx-auto flex max-w-2xl flex-col items-center px-5 pt-6 pb-5 text-center md:px-8 md:pt-8 md:pb-6 [@media(max-height:780px)]:pt-5 [@media(max-height:780px)]:pb-4 [@media(max-height:720px)]:pt-4 [@media(max-height:720px)]:pb-3">
        <h1 className="relative z-10 max-w-xl font-display text-[clamp(2.25rem,8.5vw,2.875rem)] font-bold leading-[1.12] tracking-tight text-balance [hyphens:none] [overflow-wrap:break-word] md:max-w-3xl md:text-[clamp(2.75rem,4.2vw,4.25rem)] md:leading-[1.12] [@media(max-height:780px)]:md:text-[clamp(2.5rem,3.8vw,3.5rem)] [@media(max-height:720px)]:md:text-[clamp(2.25rem,3.4vw,3rem)] [@media(max-height:720px)]:md:leading-[1.08]">
        ...
        <div className="mt-3.5 w-full md:mt-4 [@media(max-height:720px)]:mt-2.5">
          <AbsorptionStage />
        </div>
...
function AbsorptionStage() {
  ...
  return (
    <div className="relative w-full max-w-[680px]">
      <p className="relative z-10 text-lg leading-relaxed text-muted-foreground text-pretty md:text-2xl [@media(max-height:720px)]:md:text-xl">
      ...
      <div
        ref={stageRef}
        aria-hidden="true"
        className="pointer-events-none relative z-[2] mx-auto mt-2.5 mb-2.5 h-[100px] w-full overflow-visible md:mt-2 md:mb-2 md:h-[74px] [@media(max-height:720px)]:md:h-[68px]"
      >
