...
export function Hero() {
  return (
    <section
      id="top"
      className="border-b border-border scroll-mt-16 [@media(min-width:1024px)_and_(max-height:950px)]:min-h-[calc(100svh-64px)] [@media(min-width:1024px)_and_(max-height:950px)]:h-auto"
    >
      <div className="mx-auto flex max-w-2xl flex-col items-center px-5 pt-6 pb-5 text-center md:px-8 md:pt-8 md:pb-6 [@media(max-height:780px)]:pt-5 [@media(max-height:780px)]:pb-4 [@media(max-height:720px)]:pt-4 [@media(max-height:720px)]:pb-3 [@media(min-width:1024px)_and_(max-height:950px)]:!pt-6 [@media(min-width:1024px)_and_(max-height:950px)]:!pb-5">
        <h1 className="relative z-10 max-w-xl font-display text-[clamp(2.45rem,9.3vw,3.15rem)] font-bold leading-[1.12] tracking-tight text-balance [hyphens:none] [overflow-wrap:break-word] md:max-w-3xl md:text-[clamp(3rem,4.6vw,4.65rem)] md:leading-[1.12] [@media(max-height:780px)]:md:text-[clamp(2.75rem,4.15vw,3.85rem)] [@media(max-height:720px)]:md:text-[clamp(2.45rem,3.7vw,3.3rem)] [@media(max-height:720px)]:md:leading-[1.08] lg:text-[clamp(3.35rem,5.1vw,5.15rem)] [@media(max-height:720px)]:lg:!text-[clamp(3.1rem,4.65vw,4.3rem)] [@media(min-width:1024px)_and_(max-height:950px)]:!leading-[0.9]">
        ...
        <p className="relative z-10 mt-3.5 max-w-[680px] text-lg leading-relaxed text-muted-foreground text-pretty md:mt-4 md:text-2xl [@media(max-height:720px)]:mt-2.5 [@media(max-height:720px)]:md:text-xl [@media(min-width:1024px)_and_(max-height:950px)]:!mt-3">
        ...
        <p className="relative z-10 mt-2 max-w-sm text-sm text-muted-foreground text-pretty md:mt-2.5 [@media(max-height:720px)]:mt-1.5 [@media(min-width:1024px)_and_(max-height:950px)]:!mt-2">
          Для менеджеров и специалистов, которые презентуют идеи, решения и результаты.
        </p>

        <div className="mt-5 w-full md:mt-5 [@media(max-height:720px)]:mt-3.5 [@media(min-width:1024px)_and_(max-height:950px)]:!mt-4">
          <HeroComposer />
        </div>
      </div>
    </section>
